...
class CommunicationLabsPage extends StatelessWidget {
  const CommunicationLabsPage({super.key});

  @override
  Widget build(BuildContext context) {
    final List<String> videoPaths = ['video/communication.mp4'];

    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Communication Labs Videos',
